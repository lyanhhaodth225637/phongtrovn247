<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
    ...
    <a href="{{ route('frontend.home') }}" class="logo-text"><img src="{{ asset('storage/logo/logo.png') }}" alt=""
            width="50px"> PhongTro<span>VN</span>247</a><div class="logo-text "> -  Dashboard Admin </div>
            ...
            <li class="nav-item dropdown no-arrow">
                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                    ...
                    <img class="img-profile rounded-circle"
                        src="{{ asset('storage/' . (auth()->user()->avatar ?? 'default/avt_default.png')) }}">
                </a>
