    ...
    <li class="nav-item">
        ...
        <div id="collapse1" class="collapse" aria-labelledby="heading1" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{ route('admin.province') }}">Tỉnh/Thành phố</a>
                <a class="collapse-item" href="{{ route('admin.ward') }}">Xã/Phường</a>
                <a class="collapse-item" href="{{ route('admin.location') }}">Địa điểm</a>
            </div>
        </div>
    </li>
    <li class="nav-item">
        ...
        <div id="collapse2" class="collapse" aria-labelledby="heading1" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Custom Components:</h6>
                <a class="collapse-item" href="{{ route('admin.user') }}">Người dùng</a>
                <a class="collapse-item" href="{{ route('admin.ward') }}">#</a>
            </div>
        </div>
    </li>
