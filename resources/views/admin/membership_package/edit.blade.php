...
@section('content')
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                <form class="needs-validation" novalidate action="{{ route('admin.membership_package.update',['id'=>$membershipPackage->id]) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <!-- Gói thành viên -->
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <select
                                ...
                                @foreach ($memberships as $membership)
                                    <option
                                        value="{{ $membership->id }}"
                                        {{ old('membership_id', $membershipPackage->membership_id) == $membership->id ? 'selected' : '' }}>
                                        {{ $membership->name }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input
                                ...
                                value="{{ old('duration_days', $membershipPackage->duration_days) }}"
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <div class="input-group">
                                <input
                                    ...
                                    value="{{ old('price',$membershipPackage->price) }}"
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            >{{ old('description', $membershipPackage->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-12">
                            <a href="{{ route('admin.membership.show',['id'=>$membership->id, 'slug'=>$membership->slug]) }}" class="btn btn-secondary">
