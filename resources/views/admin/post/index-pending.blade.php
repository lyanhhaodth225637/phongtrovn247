...
@section('content')
    <div class="container-fluid">
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">Danh Sách Bài Viết Chờ Duyệt</h1>
        <p class="mb-4">
            Danh sách các bài viết đang chờ quản trị viên kiểm duyệt trước khi hiển thị trên hệ thống.
        </p>
                                    ...
                                    <td>
                                        @if($post->is_visible_admin)
                                            <a href="{{ route('admin.post.show', ['id' => $post->id]) }}"
                                                class="btn btn-sm btn-outline-success font-weight-bold" title="Đang hiển thị">
                                                <i class="fa fa-eye"></i> Đã hiển thị
                                            </a>
                                        @else
                                            <a href="{{ route('admin.post.show', ['id' => $post->id]) }}"
                                                class="btn btn-sm btn-outline-secondary font-weight-bold" title="Đang ẩn">
