...
@section('content')
    <div class="container-fluid">
        ...
        <p class="mb-4">Danh sách các thông báo chuyển khoản từ người dùng, phân loại theo trạng thái khớp lệnh.</p>
                ...
                <div class="card border-left-secondary shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1">Chưa khớp</div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-info shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Đã khớp</div>
            ...
            <div class="card-header py-3">
                <div class="d-flex justify-content-between align-items-center flex-wrap" style="gap:8px">
                    ...
                    <div class="d-flex flex-wrap" style="gap:6px">
                        <button class="btn btn-secondary btn-sm filter-btn active" data-status="all">Tất cả</button>
    ...
    @push('scripts')
        <script>
            ...
            // Filter buttons (ẩn/hiện row theo status, tương thích DataTables)
