        ...
        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap" style="gap:8px">
            <div>
                <h1 class="h4 mb-0 text-gray-800 font-weight-bold">
                    <i class="fas fa-file-invoice-dollar text-primary mr-2"></i>Chi tiết thông báo nạp tiền
                </h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent p-0 mb-0" style="font-size:.8rem">
                        <li class="breadcrumb-item"><a href="">Dashboard</a></li>
                        <li class="breadcrumb-item">
                            <a href="{{ route('admin.wallet_notifications.index') }}">Thông báo nạp tiền</a>
                        </li>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="font-weight-bold text-primary">
                                        {{ number_format((int) $notification->amount) }} đ
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>{{ optional($notification->notified_at)->format('d/m/Y H:i:s') ?? 'N/A' }}</td>
                                </tr>

                                <tr>
                                    <td class="text-muted">Người xử lý</td>
                                    <td>{{ $notification->handler->name ?? 'Chưa có' }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                        ...
                        <table class="table table-sm table-borderless mb-0">
                            <tbody>
                                <tr>
                                    ...
                                    <td class="font-weight-bold">{{ $notification->systemWallet?->name ?? 'N/A' }}</td>
                                </tr>

                                <tr>
                                    <td class="text-muted">Ngân hàng</td>
                                    <td>{{ $notification->bank_name ?? ($notification->systemWallet?->bank_name ?? 'N/A') }}
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="font-weight-bold text-primary">
                                        @if(isset($notification->systemWallet?->balance))
                                            {{ number_format((int) $notification->systemWallet->balance) }} đ
                                        @else
                                            N/A
                                        @endif
                                    </td>
            ...
            <div class="card shadow-sm mb-4">
                ...
                <div class="card-body">
                    <div class="alert alert-info shadow-sm">
                        ...
                        Duyệt sẽ cộng <strong>{{ number_format((int) $notification->amount) }} đ</strong>
                        vào ví của user
                        ...
                        <div class="col-md-5 mb-3 mb-md-0 d-flex align-items-end">
                            <form action="{{ route('admin.wallet_notifications.approve', $notification->id) }}" method="POST"
                                ...
                                <button type="submit" class="btn btn-success btn-block font-weight-bold"
                                    ...
                                    <i class="fas fa-check mr-1"></i> Duyệt và cộng tiền
                                </button>
                            </form>
                        </div>
                        ...
                        <div class="col-md-7">
                            <form action="{{ route('admin.wallet_notifications.reject', $notification->id) }}" method="POST">
                                ...
                                <button type="submit" class="btn btn-danger btn-block font-weight-bold"
                                    ...
                                    <i class="fas fa-times mr-1"></i> Từ chối giao dịch
                                </button>
                            </form>
                        </div>
                    </div>
