...
@section('content')
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                <form class="needs-validation" novalidate action="{{ route('admin.membership.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="number" name="priority"
                                ...
                                value="{{ old('priority') }}" placeholder="0" min="0">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="colorText" class="form-control @error('color') is-invalid @enderror"
                                    value="{{ old('color', '#4e73df') }}" placeholder="#4e73df" maxlength="7">
                                @error('color')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea name="description" class="form-control @error('description') is-invalid @enderror"
                                rows="4" placeholder="Nhập mô tả cho gói dịch vụ...">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
