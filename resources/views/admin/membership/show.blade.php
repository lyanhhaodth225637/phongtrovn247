        ...
        <div class="ms-header">
            <div class="ms-header-left">
                ...
                <div>
                    ...
                    <div class="ms-slug">
                        Slug:
                        <code style="color: {{ $membership->color }};">{{ $membership->slug }}</code>
                    </div>
                </div>
            </div>
                ...
                <div class="ms-info-card">
                    ...
                    <div class="ms-info-card-body">
                        ...
                        <div class="ms-info-row">
                            ...
                            <span class="ms-info-value">
                                <code style="background:#f1f3f7;padding:2px 7px;border-radius:5px;font-size:.8rem;color: {{ $membership->color }}">
                                        {{ $membership->slug }}
                                    </code>
                            </span>
                        </div>
                        ...
                        <div class="ms-info-row">
                            <span class="ms-info-label">Màu tiêu đề</span>
                            <span class="ms-info-value">
                                @if($membership->color)
                        ...
                        <div class="ms-info-row">
                            ...
                            <span class="ms-info-value">
                                ...
                                <span class="text-muted" style="font-size:.8rem;">
                                    {{ $membership->created_at->format('H:i') }}
                                </span>
                            </span>
                        </div>
                        ...
                        <div class="ms-info-row">
                            ...
                            <span class="ms-info-value">
                                {{ $membership->updated_at->format('d/m/Y') }}
                                <span class="text-muted" style="font-size:.8rem;">
                                    {{ $membership->updated_at->format('H:i') }}
                                </span>
                            </span>
                        </div>
                ...
                <div class="ms-pkg-card">
                    <div class="ms-pkg-card-header">
                        <h6>
                            ...
                            <span class="ms-count-badge">
                                {{ $membership->membershipPackages->count() }}
                            </span>
                        </h6>
                            ...
                            <table class="ms-table">
                                ...
                                <tbody>
                                    @foreach($membership->membershipPackages->sortBy('duration_days') as $package)
                                        <tr>
                                            <td>
                                                <span class="ms-num">{{ $loop->iteration }}</span>
                                            </td>

                                            <td>
                                                @if($package->duration_days > 1000)
                                                    <span class="ms-days-val">Vĩnh viễn</span>
                                                @else
                                                    <span class="ms-days-val">
                                                        {{ number_format($package->duration_days) }}
                                                    </span>
                                            ...
                                            <td>
                                                @if($package->description)
                                                    <span class="ms-desc-text" title="{{ $package->description }}">
                                                        {{ $package->description }}
                                                    </span>
                                                @else
                                            ...
                                            <td>
                                                <a href="{{ route('admin.membership_package.edit', ['id' => $package->id]) }}"
