...
@section('content')
    ...
    <div class="hw">
        <div class="hw-title">Lịch sử nạp tiền</div>
        ...
        <div class="filter-bar">
            ...
            <button class="f-btn" data-filter="type" data-val="deposit">Nạp tiền</button>
            <button class="f-btn" data-filter="type" data-val="promotion">Khuyến mãi</button>
                        ...
                        <tr data-type="{{ $item->type }}"
                            ...
                            <td>
                                @if($item->type === 'deposit')
                                    <span class="tbadge tbadge-deposit">Nạp tiền</span>
                                @elseif($item->type === 'promotion')
                                    @if(str_contains(strtolower($item->description ?? ''), 'giới thiệu'))
                                        <span class="tbadge tbadge-promo">Thưởng giới thiệu</span>
                                    @else
                                        <span class="tbadge tbadge-promo">Khuyến mãi</span>
                                    @endif
                                @else
                            ...
                            <td>
                                @if(in_array($item->type, ['deposit', 'promotion']))
                                    <span class="amt-pos">+{{ number_format($item->amount, 0, ',', '.') }}đ</span>
                                @else
                                    <span class="amt-neg">-{{ number_format($item->amount, 0, ',', '.') }}đ</span>
                                @endif
                            </td>
