    ...
    <div class="pc-wrap">
        <div class="page-heading">
            <div>
                ...
                <p>Cập nhật đầy đủ thông tin để bài đăng được kiểm duyệt nhanh hơn</p>
            </div>
        ...
        <form action="{{ route('user.post.update', ['id' => $post->id, 'slug' => $post->slug]) }}"
            ...
            <div class="action-bar">
                ...
                <button type="submit" class="btn-submit">
                    <i class="bi bi-check-circle-fill"></i> Cập nhật bài đăng
                </button>
            </div>
        </form>
    </div>
