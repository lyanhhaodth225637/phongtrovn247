...
<style>
/* ═══════════════════════════════════════════════════════════
   POST CREATE — inline styles, dùng chung var() từ home.css
...
.upload-hints { list-style: none; padding: 0; margin: .75rem 0 0; display: flex; flex-direction: column; gap: .3rem; }
.upload-hints li { font-size: .78rem; color: var(--muted); padding-left: 1rem; position: relative; }
.upload-hints li::before { content: '•'; position: absolute; left: 0; color: var(--primary); }
...
.btn-submit:hover { background: var(--primary-dark); transform: translateY(-1px); box-shadow: 0 6px 20px rgba(13,110,253,.4); color: #fff; }
...
.action-bar {
    ...
    position: sticky; bottom: 1rem; z-index: 400;
    margin-bottom: 2rem;
}
</style>
@endpush
...
<div class="pc-wrap">
    ...
    <div class="steps-container" id="stepsContainer">
        <div class="steps">
            <a href="#section-1" class="step"><div class="step-circle">1</div><div class="step-label">Danh mục</div></a>
            <a href="#section-2" class="step"><div class="step-circle">2</div><div class="step-label">Khu vực</div></a>
            <a href="#section-3" class="step"><div class="step-circle">3</div><div class="step-label">Mô tả</div></a>
            <a href="#section-4" class="step"><div class="step-circle">4</div><div class="step-label">Tiện ích</div></a>
            <a href="#section-5" class="step"><div class="step-circle">5</div><div class="step-label">Hình ảnh</div></a>
            <a href="#section-6" class="step"><div class="step-circle">6</div><div class="step-label">Liên hệ</div></a>
        </div>
    </div>
    ...
    <form action="{{ route('user.post.store') }}" method="POST" enctype="multipart/form-data" novalidate>
        ...
        <div class="pc-card" id="section-1">
            <div class="pc-card-header"><i class="bi bi-tag-fill"></i><h6>Loại Danh Mục</h6></div>
        ...
        <div class="pc-card" id="section-2">
            <div class="pc-card-header"><i class="bi bi-geo-alt-fill"></i><h6>Khu Vực</h6></div>
            <div class="pc-card-body">
                <div class="pc-row">
                    <div class="pc-col-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="province"
                                ...
                                autocomplete="off" list="province-list"
                    ...
                    <div class="pc-col-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="ward"
                                ...
                                autocomplete="off" list="ward-list"
                                value="{{ old('ward_name') }}" disabled>
                ...
                <div style="margin-top:.75rem">
                    ...
                    <div class="map-placeholder"><div id="map"></div></div>
        ...
        <div class="pc-card" id="section-3">
            <div class="pc-card-header"><i class="bi bi-info-circle-fill"></i><h6>Thông Tin Mô Tả</h6></div>
            <div class="pc-card-body">
                <div class="form-group">
                    ...
                    <input type="text" id="title" name="title"
                        ...
                        value="{{ old('title') }}" required minlength="30" maxlength="100">
                    <div class="char-hint">Tối thiểu 30 ký tự, tối đa 100 ký tự &nbsp;—&nbsp;<span id="titleCount">{{ strlen(old('title','')) }}</span>/100</div>
                ...
                <div class="form-group">
                    ...
                    <div class="char-hint">Tối thiểu 50 ký tự, tối đa 5000 ký tự &nbsp;—&nbsp;<span id="descCount">0</span>/5000</div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="number" id="price" name="price"
                                    ...
                                    value="{{ old('price') }}" required min="0" max="999999999">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="number" id="area" name="area"
                                    ...
                                    placeholder="VD: 25"
                                    value="{{ old('area') }}" required min="1" max="10000">
        ...
        <div class="pc-card" id="section-4">
            <div class="pc-card-header"><i class="bi bi-stars"></i><h6>Tiện Ích Nổi Bật</h6></div>
            <div class="pc-card-body">
        ...
        <div class="pc-card" id="section-5">
            <div class="pc-card-header"><i class="bi bi-images"></i><h6>Hình Ảnh</h6></div>
            <div class="pc-card-body">
                <div class="upload-zone" id="uploadZone">
                    <i class="bi bi-camera"></i>
                    <p><button type="button" class="btn-link" onclick="document.getElementById('imgInput').click()">Tải ảnh từ thiết bị</button></p>
                ...
                @error('images')<div class="invalid-feedback" style="display:block">{{ $message }}</div>@enderror
                @error('images.*')<div class="invalid-feedback" style="display:block">{{ $message }}</div>@enderror
        ...
        <div class="pc-card" id="section-6">
            <div class="pc-card-header"><i class="bi bi-person-vcard-fill"></i><h6>Thông Tin Liên Hệ</h6></div>
            <div class="pc-card-body">
                <div class="pc-row">
                    <div class="pc-col-6">
                        <div class="form-group">
        ...
        <div class="action-bar">
            <a href="{{ route('user.profile') }}" class="btn-outline-primary">
